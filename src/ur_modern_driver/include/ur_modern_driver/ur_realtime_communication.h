...
public:
	...
	void setSpeedl(double q0, double q1, double q2, double q3, double q4, //urscript 的 speedl()接口,自己写的
			double q5, double acc = 1.);
	void setMovel(double q0, double q1, double q2, double q3, double q4, //urscript 的 speedl()接口,自己写的
			double q5, double acc = 1.,double vel =0.25);
