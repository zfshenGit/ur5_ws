...
public:
	...
	void setSpeedl(double q0, double q1, double q2, double q3, double q4, //末端速度,自己写的
			double q5, double acc = 1.);

	void setMovel(double q0, double q1, double q2, double q3, double q4, //tcp 位置,自己写的
			double q5, double acc = 1.4 ,double vel =0.25);
