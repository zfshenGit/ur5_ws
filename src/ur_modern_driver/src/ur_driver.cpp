...
std::vector<double> UrDriver::interp_cubic(double t, double T, //插值
...
void UrDriver::setSpeedl(double q0, double q1, double q2, double q3, double q4,
		double q5, double acc) {
	rt_interface_->setSpeedl(q0, q1, q2, q3, q4, q5, acc);
}

void UrDriver::setMovel(double q0, double q1, double q2, double q3, double q4,
		double q5, double acc,double vel){
	rt_interface_->setMovel(q0,q1,q2,q3,q4,q5,acc,vel);
}
